      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex items-center mt-1">
            ...
            <button 
              onClick={() => details.transactionId && copyToClipboard(details.transactionId)}
        ...
        <div>
          ...
          <div className="flex items-center mt-1">
            ...
            <button 
              onClick={() => details.transactionHash && copyToClipboard(details.transactionHash)}
              className="ml-2 p-2 text-gray-500 hover:text-gray-700"
              title="Copy to clipboard"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        {/* Display Token Type */}
        <div>
          <h3 className="text-sm font-medium text-gray-700">Token Type</h3>
          <p className="text-sm mt-1 font-medium">
            {(details.tags && details.tags.find(tag => tag.name === 'Token')?.value) || 'ETHEREUM'}
          </p>
        </div>
